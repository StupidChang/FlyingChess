 ...
 *
 * 真心話大冒險的題庫原本也在排除名單裡,理由是「房主的會員資格決定整間房,
 * 用單一裝置的 session 去解鎖一間多人房會很怪」。後來那個遊戲改成同機遊玩
 * (所有人輪流用同一台裝置,見 TruthDareController::create),那條理由就不成立了 ——
 * 只有一台裝置、一個 session,跟其他四個小遊戲沒有差別,所以現在一併適用。
 *
