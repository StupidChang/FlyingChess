...
return [
    ...
    'rewarded_ad_no_fill' => 'No ad available right now — the unlock is yours anyway.',
    ...
    'king_agree_tip' => 'Agree on the dare or reward for this round first, then flip together',
    'king_agree_btn' => 'Flip',
    'king_flip_now' => 'Flip!',
    ...
    // 自訂轉盤(帶權重)
    'cw_title' => 'Custom Wheel',
    'cw_subtitle' => 'Add your own options and weights — the wheel updates instantly',
    'cw_placeholder' => 'Add an option…',
    'cw_percent' => 'Weight',
    'cw_empty' => 'No options yet — add at least two above',
    'cw_even' => 'Even split',
    'cw_total' => 'Total :n% (need not be exactly 100 — weights are scaled)',
    'cw_effective' => 'Effective share',
    'cw_err_dup' => 'That option already exists',
    'cw_err_max' => 'Up to 20 options',
    'cw_err_pct' => 'Weight must be an integer from 1 to 100',
    'cw_err_need' => 'Please enter an option first',
    'cw_start' => '🎮 Start game',
    'cw_start_hint' => 'Runs the same flow as the other wheels: set players, then take turns',
    'cw_start_unavailable' => 'Please reload the page and try again',
    'cw_save' => 'Save',
    'cw_save_placeholder' => 'Name this wheel',
    'cw_saved' => 'Saved',
    'cw_saved_list' => 'My saved wheels',
    'cw_load' => 'Load',
    'cw_loaded' => 'Loaded',
    'cw_save_need' => 'Add at least two options before saving',
    'cw_save_need_name' => 'Please enter a name',
    'cw_save_failed' => 'Could not save. Please try again.',
    'cw_save_limit' => 'You can save up to :n wheels',
