...
return [
    ...
    'td_mode_couple' => '情侶場',
    'td_mode_party' => '多人場',
    'td_mode_hint' => '會依人數不同,出現不同的題目。',
    'td_level_mild' => '輕度',
    'td_level_medium' => '中度',
    'td_level_intense' => '重度',
    'td_level_mild_plus' => '輕中',
    'td_level_medium_plus' => '中重',
    'td_scale_mild_plus_desc' => '從想像走向具體 —— 開始問到偏好、經驗與身體的細節,但仍不描寫性行為。',
    'td_scale_medium_plus_desc' => '接近露骨的邊界 —— 講到過程、感受與想嘗試的玩法,只差沒有指名動作。',
    'td_scale_summary' => '題目尺度說明 —— 免費與付費差在哪',
    'td_scale_mild_desc' => '告白、心動、調情、親密的想像。會講到身體與慾望,但不描寫性行為。',
    'td_scale_medium_desc' => '明確的身體話題與親密互動 —— 敏感部位、偏好、主導或被主導。',
    'td_scale_intense_desc' => '直接描寫性行為 —— 體位、口交、插入、情趣道具的具體內容。',
    'td_scale_paywall' => '輕度全部免費;中度大多免費,少數需要解鎖;重度要看廣告或成為會員。介意的話就別解鎖,免費的部分本身也玩得完一整場。',
    'td_tier_unlocked' => '付費題庫已解鎖,這一場抽得到全部題目。',
    ...
    'player_fallback' => '玩家',
    'err_host_only_start' => '只有房主可以開始遊戲',
    'err_not_in_game' => '你不在此遊戲中',
    'err_game_started_or_ended' => '遊戲已經開始或結束',
    'err_room_full' => '房間已滿',
    'err_need_two_players' => '至少需要 2 位玩家才能開始',
    'err_not_your_turn' => '還沒輪到你',
    'err_already_rolled' => '已經擲過骰子了',
    'err_roll_first' => '請先擲骰子',
    'err_invalid_move' => '無效的移動',
    ...
    'td_room_full' => '房間已滿（最多 6 人）。',
    'td_need_one_player' => '至少需要 1 位玩家才能開始。',
