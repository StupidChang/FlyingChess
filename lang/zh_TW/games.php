...
return [
    ...
    'td_scale_free_label' => '免費・曖昧級',
    'td_scale_free_desc' => '告白、心動、調情、親密的想像。會講到身體與慾望,但不會描寫性行為的細節。',
    'td_scale_paid_label' => '付費・18+ 露骨級',
    'td_scale_paid_desc' => '直接描寫性行為 —— 包含體位、口交、插入、敏感部位與情趣道具的具體內容。介意的話就別解鎖,免費題庫本身也玩得完一整場。',
